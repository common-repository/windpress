...
class Main implements IntegrationInterface
{
    public function __construct()
    {
        ...
        if ($this->is_enabled()) {
            (new \WindPress\WindPress\Integration\Kadence\Compile())();
        }
    }
    ...
    {
        $providers[] = ['id' => $this->get_name(), 'name' => \__('Kadence WP', 'windpress'), 'description' => \__('The Kadence WP integration. It requires the Gutenberg/Block Editor integration enabled.', 'windpress'), 'callback' => fn() => [], 'enabled' => $this->is_enabled(), 'meta' => ['experimental' => \true]];
        return $providers;
    }
}
