...
class Main implements IntegrationInterface
{
    ...
    {
        $providers[] = ['id' => $this->get_name(), 'name' => \__('Timber', 'windpress'), 'description' => \__('Timber integration', 'windpress'), 'callback' => \WindPress\WindPress\Integration\Timber\Compile::class];
        return $providers;
    }
}
