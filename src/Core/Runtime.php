...
class Runtime
{
    ...
    {
        $metadata = ['_version' => WIND_PRESS::VERSION, '_tailwind_version' => static::tailwindcss_version(), '_via_wp_org' => !Common::is_updater_library_available(), 'is_ubiquitous' => $this->is_ubiquitous_panel(), 'assets' => ['url' => AssetVite::asset_base_url()], 'user_data' => ['data_dir' => [
